...
# Unit tests for CybridApiId::BankApplicationsIdpApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BankApplicationsIdpApi' do
  before do
  ...
  describe 'test an instance of BankApplicationsIdpApi' do
    it 'should create an instance of BankApplicationsIdpApi' do
      expect(@api_instance).to be_instance_of(CybridApiId::BankApplicationsIdpApi)
    end
  end

  # unit tests for create_bank_application
  # Create bank application
  # Creates a bank OAuth2 application.  Required scope: **banks:write**
  # @param post_bank_application_idp_model 
  # @param [Hash] opts the optional parameters
  # @return [ApplicationWithSecretIdpModel]
  describe 'create_bank_application test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_bank_applications
  ...
  describe 'list_bank_applications test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
