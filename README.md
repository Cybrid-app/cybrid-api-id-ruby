...
```shell
gem install ./cybrid_api_id_ruby-0.129.748.gem
```

(for development, run `gem install --dev ./cybrid_api_id_ruby-0.129.748.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'cybrid_api_id_ruby', '~> 0.129.748'
...
*CybridApiId::UsersIdpApi* | [**update_user**](docs/UsersIdpApi.md#update_user) | **PATCH** /api/users/{user_guid} | Update User
...
## Documentation for Models
 ...
 - [CybridApiId::GroupAuthorizationIdpModel](docs/GroupAuthorizationIdpModel.md)
 - [CybridApiId::GroupAuthorizationListIdpModel](docs/GroupAuthorizationListIdpModel.md)
 - [CybridApiId::GroupIdpModel](docs/GroupIdpModel.md)
 - [CybridApiId::GroupListIdpModel](docs/GroupListIdpModel.md)
