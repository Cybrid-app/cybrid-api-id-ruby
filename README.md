...
```shell
gem install ./cybrid_api_id_ruby-0.115.10.gem
```

(for development, run `gem install --dev ./cybrid_api_id_ruby-0.115.10.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'cybrid_api_id_ruby', '~> 0.115.10'
...
begin
  ...
  puts "Exception when calling ApplicationsIdpApi->discard_application: #{e}"
end
...
------------ | ------------- | ------------- | -------------
*CybridApiId::ApplicationsIdpApi* | [**discard_application**](docs/ApplicationsIdpApi.md#discard_application) | **DELETE** /api/applications/{client_id} | Discard Application
