...
module CybridApiId
  class OrganizationApplicationsIdpApi
    ...
    # @param post_organization_application_idp_model [PostOrganizationApplicationIdpModel] 
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_organization_application(client_id, opts = {})
      delete_organization_application_with_http_info(client_id, opts)
      nil
    end
    ...
    def delete_organization_application_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationApplicationsIdpApi.delete_organization_application ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OrganizationApplicationsIdpApi.delete_organization_application"
      end
      # resource path
      local_var_path = '/api/organization_applications/{client_id}'.sub('{' + 'client_id' + '}', CGI.escape(client_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"OrganizationApplicationsIdpApi.delete_organization_application",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationApplicationsIdpApi#delete_organization_application\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_organization_application(client_id, opts = {})
      data, _status_code, _headers = get_organization_application_with_http_info(client_id, opts)
      data
    end
    ...
    def get_organization_application_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationApplicationsIdpApi.get_organization_application ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OrganizationApplicationsIdpApi.get_organization_application"
      end
      # resource path
      local_var_path = '/api/organization_applications/{client_id}'.sub('{' + 'client_id' + '}', CGI.escape(client_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"OrganizationApplicationsIdpApi.get_organization_application",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationApplicationsIdpApi#get_organization_application\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ApplicationIdpModel]
    def update_organization_application(client_id, patch_application_idp_model, opts = {})
      data, _status_code, _headers = update_organization_application_with_http_info(client_id, patch_application_idp_model, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplicationIdpModel, Integer, Hash)>] ApplicationIdpModel data, response status code and response headers
    def update_organization_application_with_http_info(client_id, patch_application_idp_model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationApplicationsIdpApi.update_organization_application ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OrganizationApplicationsIdpApi.update_organization_application"
      end
      ...
      if @api_client.config.client_side_validation && patch_application_idp_model.nil?
        fail ArgumentError, "Missing the required parameter 'patch_application_idp_model' when calling OrganizationApplicationsIdpApi.update_organization_application"
      end
      # resource path
      local_var_path = '/api/organization_applications/{client_id}'.sub('{' + 'client_id' + '}', CGI.escape(client_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"OrganizationApplicationsIdpApi.update_organization_application",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationApplicationsIdpApi#update_organization_application\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
