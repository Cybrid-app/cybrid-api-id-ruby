...
module CybridApiId
  class UserIdpModel
    ...
    def username=(username)
      if !username.nil? && username.to_s.length > 128
        fail ArgumentError, 'invalid value for "username", the character length must be smaller than or equal to 128.'
      end
    ...
    def hash
      [guid, username, email, allowed_scopes, created_at, updated_at].hash
    end
