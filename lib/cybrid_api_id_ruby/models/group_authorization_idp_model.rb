...
module CybridApiId
  class GroupAuthorizationIdpModel
    # The group authorization's guid.
    attr_accessor :guid

    # Guid of the group.
    attr_accessor :group_guid
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiId::GroupAuthorizationIdpModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiId::GroupAuthorizationIdpModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'group_guid')
        self.group_guid = attributes[:'group_guid']
      end
    ...
    def list_invalid_properties
      ...
      if @group_guid.nil?
        invalid_properties.push('invalid value for "group_guid", group_guid cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @group_guid.nil?
    ...
    def hash
      [guid, group_guid, resource_guid, resource_type, allowed_scopes, created_at, updated_at].hash
    end
